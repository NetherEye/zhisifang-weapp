...
/***/ "../../../../Private/wxapp/common/allApi.js":
/*!*****************************************!*\
  !*** D:/Private/wxapp/common/allApi.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _checkToken$login$reg;function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} // 接口
var url = 'https://zsf.gzeducard.net',
// let url = 'https://bag.bftudou.com',
proxy = '/wxapi';var _default = (_checkToken$login$reg = {
  ...
  getNearbySc: url + proxy + '/nearbyScenic' }, _defineProperty(_checkToken$login$reg, "getNearbySc",
url + proxy + '/nearbyScenic'), _defineProperty(_checkToken$login$reg, "searchList",
url + proxy + '/searchList'), _defineProperty(_checkToken$login$reg, "search",
url + proxy + '/search'), _defineProperty(_checkToken$login$reg, "voice",
url + proxy + '/voice'), _defineProperty(_checkToken$login$reg, "unlockScenic",
url + proxy + '/unlockScenic'), _defineProperty(_checkToken$login$reg, "createOrder",


url + proxy + '/createOrder'), _defineProperty(_checkToken$login$reg, "payOrder",
url + proxy + '/local/orderPay'), _defineProperty(_checkToken$login$reg, "getMoneyHide",


url + proxy + '/switch'), _checkToken$login$reg);exports.default = _default;

/***/ }),

/***/ "../../../../Private/wxapp/common/http.js":
/*!***************************************!*\
  !*** D:/Private/wxapp/common/http.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var httpCount = 0;var

http = /*#__PURE__*/function () {function http() {_classCallCheck(this, http);}_createClass(http, [{ key: "rq", value: function rq()
        ...
        uni.request({
          ...
          success: function success(res) {
            ...
            if (res.data.code === 214) {
              ...
              var path = pages[pages.length - 1].route.slice(pages[pages.length - 1].route.lastIndexOf('/') + 1);
              uni.redirectTo({
...
/***/ "../../../../Private/wxapp/common/tools.js":
/*!****************************************!*\
  !*** D:/Private/wxapp/common/tools.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js"));var _allApi = _interopRequireDefault(__webpack_require__(/*! ./allApi.js */ "../../../../Private/wxapp/common/allApi.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}

// 校验是否存在 登录态及是否过期
var isLogin = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var key;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            key = uni.getStorageSync('login-token');return _context.abrupt("return",
            new Promise(function (reslove) {
              if (key) {
                // 存在key，则校验是否过期
                uni.request({
                  url: _allApi.default.checkToken,
                  header: {
                    'content-type': 'application/x-www-form-urlencoded', // 默认值
                    'token': key },
            ...
            }));case 2:case "end":return _context.stop();}}}, _callee, this);}));return function isLogin() {return _ref.apply(this, arguments);};}();



// 登录 ？ 登录最好实在 登录态失效或者没有时发起 并保证失效静默登录
var logining = /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:return _context2.abrupt("return",
            new Promise(function (reslove) {
              uni.login({
                success: function success(res) {
                  // 开始后台登录
                  uni.request({
                    url: _allApi.default.login,
                    data: {
                      code: res.code },
            ...
            }));case 1:case "end":return _context2.stop();}}}, _callee2, this);}));return function logining() {return _ref2.apply(this, arguments);};}();


// 注册 : 注册行为只会在授权页面进行 
var registering = /*#__PURE__*/function () {var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:return _context3.abrupt("return",
            new Promise(function (reslove) {
              uni.getUserInfo({
                success: function success(res) {
                  var userInfo = res;
            ...
            }));case 1:case "end":return _context3.stop();}}}, _callee3, this);}));return function registering() {return _ref3.apply(this, arguments);};}();


var handleNumber = function handleNumber(val) {
  if (val >= 10000) {
    var cVal = String((val / 10000).toFixed(1));
...
// 获取 MoneyHide
var getMoneyHide = function getMoneyHide() {
  return new Promise(function (reslove) {
    uni.request({
      url: _allApi.default.getMoneyHide,
      method: 'GET',
      header: {
        'content-type': 'application/x-www-form-urlencoded' // 默认值
      },
...
/***/ "../../../../Private/wxapp/pages.json":
/*!***********************************!*\
  !*** D:/Private/wxapp/pages.json ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
